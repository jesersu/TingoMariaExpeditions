...
import ListingStayDetailPage1 from "containers/ListingDetailPage/ListingStayDetailPage1";
import ListingStayDetailPage2 from "containers/ListingDetailPage/ListingStayDetailPage2";
import ListingStayDetailPage3 from "containers/ListingDetailPage/ListingStayDetailPage3";
import ListingStayDetailPage4 from "containers/ListingDetailPage/ListingStayDetailPage4";
...
export const pages: Page[] = [
  ...
  { path: "/pack-1", component: ListingStayDetailPage1 },
  { path: "/listing-stay-detail-2", component: ListingStayDetailPage2 },
  { path: "/listing-stay-detail-3", component: ListingStayDetailPage3 },
  { path: "/listing-stay-detail-4", component: ListingStayDetailPage4 },
