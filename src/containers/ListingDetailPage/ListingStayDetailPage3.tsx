...
const PHOTOS: string[] = [
  "http://www.tingomariaexpedition.com/paquetes/ln1.png",
  "http://www.tingomariaexpedition.com/paquetes/ln2.jpg",
  "http://www.tingomariaexpedition.com/paquetes/ln3.png",
  "http://www.tingomariaexpedition.com/paquetes/ln4.jpg",
  "http://www.tingomariaexpedition.com/paquetes/ln5.jpg",
];
...
const ListingStayDetailPage3: FC<ListingStayDetailPageProps> = ({
  className = "",
  isPreviewMode,
    ...
    return (
      <div className="listingSection__wrap">
        ...
        <div className="text-neutral-6000 dark:text-neutral-300">
          <span>
          · 09:30 A.M. Recojo en el hotel, Inicio del Tour.  <br />

· En 35 minutos. Llegaremos a la localidad de Tambillo Chico, donde los expertos a cargo de esta actividad explicarán sobre el uso del equipo e instruirán en la técnica correcta para realizar la escalada de manera segura.  <br />

· Realizaremos el deportes de aventura donde la adrenalina llega al máximo durante 4 horas, en este lugar se pondrá a prueba toda nuestra destreza.  <br />

· Escalaremos 12 cascadas, en cada parada tomaremos fotos con caída de agua recibiendo los masajes hidroterápicos y llegar así a la Catarata Velo de las Ninfas.  <br />

· Luego el retorno será en una caminata de aproximadamente 30 minutos por el camino alterno a la carretera principal  <br />

· 03:00 P.M. Almuerzo restaurante turístico Cueva de las Pavas.  <br />

· 04:00 P.M. Retorno a la ciudad de Tingo María Expedition.
...
export default ListingStayDetailPage3;
