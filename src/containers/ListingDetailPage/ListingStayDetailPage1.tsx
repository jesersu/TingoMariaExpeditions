...
const PHOTOS: string[] = [
  "http://www.tingomariaexpedition.com/paquetes/fd1.jpg",
  "http://www.tingomariaexpedition.com/paquetes/fd2.jpg",
  "http://www.tingomariaexpedition.com/paquetes/fd3.png",
  "http://www.tingomariaexpedition.com/paquetes/fd4.png",
  "https://www.wamanadventures.com/blog/wp-content/uploads/2020/09/Dise%C3%B1o-sin-t%C3%ADtulo-1-3.jpg",
];
...
const ListingStayDetailPage1: FC<ListingStayDetailPageProps> = ({
  className = "",
  isPreviewMode,
    ...
    return (
      <div className="listingSection__wrap">
        ...
        <div className="text-neutral-6000 dark:text-neutral-300">      
          ...
          · 10:00 am Inicio del tour.    <br />      
          · La cueva de las Lechuzas     <br /> 
          · Fábrica de chocolates  <br />

          · Aguas sulfurosas<br />

          · Mirador Jacintillo<br />

          · Balneario Cueva de las Pavas – Almuerzo Típico<br />

          · Catarata Santa Carmen.<br />

          · Mirador de la bella Durmiente.<br />

          · 6:30 pm Retorno al hotel
          </span>
        </div>
      </div>
    );
...
export default ListingStayDetailPage1;
