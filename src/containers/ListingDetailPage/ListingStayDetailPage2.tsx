...
const PHOTOS: string[] = [
  "http://www.tingomariaexpedition.com/paquetes/lm.jpg",
  "http://www.tingomariaexpedition.com/paquetes/lm2.png",
  "http://www.tingomariaexpedition.com/paquetes/lm3.png",
  "http://www.tingomariaexpedition.com/paquetes/lm4.jpg",
  "http://www.tingomariaexpedition.com/paquetes/lm5.jpg",
];
...
const ListingStayDetailPage2: FC<ListingStayDetailPageProps> = ({
  className = "",
  isPreviewMode,
    ...
    return (
      <div className="listingSection__wrap">
        ...
        <div className="text-neutral-6000 dark:text-neutral-300">
          <span>
          · Recojo en el hotel, Inicio del tour 10.00 am. <br />

        · Dirección hacia el Caserío el Milagro a 25 km de Tingo María Expedition. <br />

        · Paseo en bote artesanal, Practicaremos la Natación, utilizaremos <br />

        · la arcilla para la exfoliación del rostro y cuerpo. <br />

        · Visitaremos el museo Amazónico y observaremos el Paiche. <br />

        · Visitaremos la Jungla choza de Tarzán y el Árbol del deseo Lupuna <br />

        · más de 400 años. <br />

        · Almuerzo Típico de la Selva. <br />

        · 05:00 P.M. Retorno al hotel <br />
          </span>
          <br />
...
export default ListingStayDetailPage2;
